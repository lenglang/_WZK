...
namespace WZK
{
    public class UtilityEditor : Editor
    {
        ...
        [MenuItem("WZK/清空持久化数据")]
        static void 清空持久化数据()
        {
            Directory.Delete(Application.persistentDataPath, true);
            PlayerPrefs.DeleteAll();
        }
        [MenuItem("WZK/图片/一键查找贴图")]
        static void 一键查找贴图()
        {
