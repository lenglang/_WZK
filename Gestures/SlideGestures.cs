...
namespace WZK
{
    ...
    public class SlideGestures : MonoBehaviour, IBeginDragHandler, IDragHandler
    {
        ...
        [HideInInspector]
        public Direction _direction = Direction.从右到左;//滑动方向
        [HideInInspector]
        ...
        public Action<Direction> _onDirectionComplete;//方向委托
        public Action _onDragComplete;//只要滑动
        ...
        private bool _isStarting = false;//是否开始
        /// <summary>
        /// 开始拖拽
        /// </summary>
        ...
        public void OnDrag(PointerEventData evenData)
        {
            ...
            {
                _isStarting = false;
                if (_onDirectionComplete != null) _onDirectionComplete(dragDir);
            }
